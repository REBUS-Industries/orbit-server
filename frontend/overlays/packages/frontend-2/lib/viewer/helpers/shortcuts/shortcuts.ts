...
export const ViewModeShortcuts = {
  ...
  // ORBIT: arctic-style fixture category colours — placed after Arctic so the
  // button is visible without scrolling the view-mode strip.
  SetViewModeFixtureColor: {
    name: 'Fixtures',
    description:
      'An arctic-style conceptual view that colours fixtures using PRISM category colours from object properties.',
    modifiers: [ModifierKeys.Shift],
    key: 'Digit6',
    action: 'SetViewModeFixtureColor',
    viewMode: ViewMode.FIXTURE_COLOR
  },
  SetViewModeSolid: {
    name: 'Solid',
    description:
