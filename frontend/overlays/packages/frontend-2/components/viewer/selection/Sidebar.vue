    ...
    >
      ...
      <template #actions>
        <div class="flex gap-x-0.5 items-center">
          <FormButton
            v-tippy="'Expand all properties'"
            hide-text
            color="subtle"
            size="sm"
            @click="expandAllProperties"
          >
            Expand all
          </FormButton>
          <FormButton
            v-tippy="'Collapse all properties'"
            hide-text
            color="subtle"
            size="sm"
            @click="collapseAllProperties"
          >
            Collapse
          </FormButton>
...
provide<SelectionPanelExpandControl>(SELECTION_PANEL_EXPAND_KEY, {
  expandAllTick,
  collapseAllTick
})
