...
<template>
  <div>
    ...
    <ViewerLayoutPanel class="mt-1 p-2 flex justify-between items-center gap-2">
      <div class="min-w-0 flex-1 overflow-x-auto">
        <ViewerButtonGroup>
          ...
          >
            <span class="text-body-2xs text-foreground px-2 py-1 whitespace-nowrap">
              {{ shortcut.name }}
            </span>
          </ViewerButtonGroupButton>
        </ViewerButtonGroup>
      ...
      <button
        class="size-6 shrink-0 flex items-center justify-center rounded-md"
        :class="[
          showSettings &&
...
const viewModeShortcuts = [
  ViewModeShortcuts.SetViewModeDefault,
  ViewModeShortcuts.SetViewModeShaded,
  ViewModeShortcuts.SetViewModeArctic,
  ViewModeShortcuts.SetViewModeFixtureColor,
  ViewModeShortcuts.SetViewModeSolid,
  ViewModeShortcuts.SetViewModePen
]
