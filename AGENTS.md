...
## Key facts
- Prod = VM 211 (`orbit.rebus.industries`); PRISM dev = VM 212 (`prism-dev.rebus.industries`), both SRV01.
...
## Scope
WRITE here / REBUS-Industries / VM 211–212 only. CheekiSkrub + Speckle VMs (201/301) are READ-ONLY.
